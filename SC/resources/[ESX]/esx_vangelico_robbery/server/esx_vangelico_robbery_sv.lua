...
RegisterServerEvent('esx_vangelico_robbery:gioilrhackelli')
AddEventHandler('esx_vangelico_robbery:gioilrhackelli', function()

	local xPlayer = ESX.GetPlayerFromId(source)

	xPlayer.addInventoryItem('jewels', 6)
end)
...
RegisterServerEvent('lester:venlrhackdita')
AddEventHandler('lester:venlrhackdita', function()
