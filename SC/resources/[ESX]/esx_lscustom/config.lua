...
Config.Zones = {
	...
	ls7 = {  --Bennys
	Pos   = {x = -189.6573, y = -1271.113, z = 31.21025},
	Size  = {x = 3.0, y = 3.0, z = 0.2},
	Color = {r = 204, g = 204, b = 0},
	Marker= 1,
	Hint  = _U('press_custom')
	...
	ls9 = {  --heli
	Pos   = {x = -147.893, y = -1269.09, z = 49.720},
	Size  = {x = 3.0, y = 3.0, z = 0.2},
	Color = {r = 204, g = 204, b = 0},
	Marker= 1,
	Hint  = _U('press_custom')
	...
	ls10 = {  --paleto
    Pos   = {x = 110.72, y = 6626.33, z = 31.79},
    Size  = {x = 3.0, y = 3.0, z = 0.2},
    Color = {r = 204, g = 204, b = 0},
    Marker= 1,
    Hint  = _U('press_custom')
...
Config.Menus = {
	...
	modEngine = {
		...
		parent = 'upgrades',
		modType = 11,
		price = {10.95, 25.56, 35.12, 50.53}
	},
	modBrakes = {
		label = _U('brakes'),
		parent = 'upgrades',
		modType = 12,
		price = {1.65, 3.3, 8.6, 13.95}
	},
	modTransmission = {
		label = _U('transmission'),
		parent = 'upgrades',
		modType = 13,
		price = {10.95, 18.93, 25.51}
	},
	modSuspension = {
		label = _U('suspension'),
		parent = 'upgrades',
		modType = 15,
		price = {1.72, 2.44, 4.88, 5.77, 10.2}
	},
	modArmor = {
		label = _U('armor'),
		parent = 'upgrades',
