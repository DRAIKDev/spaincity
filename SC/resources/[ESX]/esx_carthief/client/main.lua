...
function SpawnCar()
	ESX.TriggerServerCallback('812UJHJHJ812EHH91EJSJQ9:isActive', function(isActive, cooldown)
		if cooldown <= 0 then
			if isActive == 0 then
				ESX.TriggerServerCallback('812UJHJHJ812EHH91EJSJQ9:anycops', function(anycops)
					if anycops >= Config.CopsRequired then
						...
						TriggerServerEvent('812UJHJHJ812EHH91EJSJQ9:registerActivity', 1)
						TriggerServerEvent('812UJHJHJ812EHH91EJSJQ9:registerActivitym', 1)
						TriggerServerEvent('812UJHJHJ812EHH91EJSJQ9:registerActivityg', 1)
						TriggerServerEvent('812UJHJHJ812EHH91EJSJQ9:registerActivityb', 1)
...
function FinishDelivery()
  if(GetVehiclePedIsIn(GetPlayerPed(-1), false) == car) and GetEntitySpeed(car) < 3 then
    ...
    --Pay the poor fella
		...
		TriggerServerEvent('812UJHJHJ812EHH91EJSJQ9:PAITH', finalpayment)

		--Register Activity
		TriggerServerEvent('812UJHJHJ812EHH91EJSJQ9:registerActivity', 0)
		TriggerServerEvent('812UJHJHJ812EHH91EJSJQ9:registerActivitym', 0)
		TriggerServerEvent('812UJHJHJ812EHH91EJSJQ9:registerActivityb', 0)
		TriggerServerEvent('812UJHJHJ812EHH91EJSJQ9:registerActivityg', 0)
    --For delivery blip
    isTaken = 0
    ...
    TriggerServerEvent('812UJHJHJ812EHH91EJSJQ9:stopalertcops')
	TriggerServerEvent('812UJHJHJ812EHH91EJSJQ9:stopalertcopsm')
	TriggerServerEvent('812UJHJHJ812EHH91EJSJQ9:stopalertcopsg')
	TriggerServerEvent('812UJHJHJ812EHH91EJSJQ9:stopalertcopsb')	
  else
...
Citizen.CreateThread(function()
  while true do
    ...
    if isTaken == 1 and IsPedInAnyVehicle(GetPlayerPed(-1)) then
      ...
      TriggerServerEvent('812UJHJHJ812EHH91EJSJQ9:alertcops', coords.x, coords.y, coords.z)
	  TriggerServerEvent('812UJHJHJ812EHH91EJSJQ9:alertcopsm', coords.x, coords.y, coords.z)
...
RegisterNetEvent('812UJHJHJ812EHH91EJSJQ9:removecopblip')
AddEventHandler('812UJHJHJ812EHH91EJSJQ9:removecopblip', function()
		RemoveBlip(copblip)
end)

RegisterNetEvent('812UJHJHJ812EHH91EJSJQ9:setcopblip')
AddEventHandler('812UJHJHJ812EHH91EJSJQ9:setcopblip', function(cx,cy,cz)
		RemoveBlip(copblip)
...
RegisterNetEvent('812UJHJHJ812EHH91EJSJQ9:setcopnotification')
AddEventHandler('812UJHJHJ812EHH91EJSJQ9:setcopnotification', function()
	ESX.ShowNotification(_U('car_stealing_in_progress'))
end)


AddEventHandler('812UJHJHJ812EHH91EJSJQ9:hasEnteredMarker', function(zone)
...
AddEventHandler('812UJHJHJ812EHH91EJSJQ9:hasExitedMarker', function(zone)
	CurrentAction = nil
...
Citizen.CreateThread(function()
  while true do
		...
		if isInMarker and not HasAlreadyEnteredMarker then
			...
			TriggerEvent('812UJHJHJ812EHH91EJSJQ9:hasEnteredMarker', currentZone)
		end
		if not isInMarker and HasAlreadyEnteredMarker then
			HasAlreadyEnteredMarker = false
			TriggerEvent('812UJHJHJ812EHH91EJSJQ9:hasExitedMarker', LastZone)
		end
	end
end)
