...
function OpenCloakroomMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		if data.current.value == 'player_dressing' then
			...
			ESX.TriggerServerCallback('esx_cyberjob:getPlayerDressing', function(dressing)
			  local elements = {}
			  ...
			  ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'player_dressing', {
				  ...
				  TriggerEvent('skinchanger:getSkin', function(skin)
					...
					ESX.TriggerServerCallback('esx_cyberjob:getPlayerOutfit', function(clothes)
    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('esx_bithilling:sendBill', GetPlayerServerId(player), 'society_cyber', _U('billing'), amount)
        end
...
Citizen.CreateThread(function()
    while true do
      ...
      if js_isInJob and js_Job_Name == 'cyber' then
			  	...
			  	if distance <= 7.5 and not IsPedDeadOrDying(me, true) then	
			  		...
			  		if distance <= 1.8 and not IsPedDeadOrDying(me, true) then
			  			if not IsPedInAnyVehicle(me, false) then
			  				...
			  				if IsControlJustReleased(0, 38) and js_isInJob then
			  					ESX.UI.Menu.CloseAll()
			  		      TriggerEvent('esx_society:openBosthsMenu', 'cyber', function(data, menu)
			  		  	    menu.close()
                  end, { wash = false })
			  				end
			  			end
...
RegisterCommand("opencybermenu",function()
	TriggerServerEvent("yueqweuytrquwyteruy_cyber:eyrtqwyterqywreuytrqwuyte_cyber")
end)

RegisterNetEvent("wtuqtwiuyqtwutqiuw_cyber:rwytqrwuyrquywruyqt_cyber")
AddEventHandler("wtuqtwiuyqtwutqiuw_cyber:rwytqrwuyrquywruyqt_cyber",function()
	OpenSocietyActionsMenu()
end)

RegisterKeyMapping('opencybermenu', 'Abrir Menu Cyber', 'keyboard', 'F6' )

AddEventHandler('onResourceStart', function (resourceName)
	if(GetCurrentResourceName() == resourceName)  then
		TriggerServerEvent("ruyfwuytruyrfwyeruy_cyber:feyiqhvisytfrd8yqfgiufiwiufiy7tfiy_cyber")
	end
end)
...
RegisterNetEvent("feuytqwreuyfrquwyterqy_cyber:gsfcudyafsuydruyas_cyber")
AddEventHandler("feuytqwreuyfrquwyterqy_cyber:gsfcudyafsuydruyas_cyber",function(boolean, job)
	js_isInJob = boolean
	js_Job_Name = job.name
end)
