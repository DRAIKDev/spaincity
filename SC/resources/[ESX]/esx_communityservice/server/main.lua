...
RegisterServerEvent('esx_communityservice:sendToComlrhackmunityServiceJSHDJAHDHYUQGHDGAJHSGDJHAGDJHAGSDAJHGBHJC')
AddEventHandler('esx_communityservice:sendToComlrhackmunityServiceJSHDJAHDHYUQGHDGAJHSGDJHAGDJHAGSDAJHGBHJC', function(target, actions_count)
