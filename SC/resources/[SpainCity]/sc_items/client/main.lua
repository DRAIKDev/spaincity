...
RegisterNetEvent('LUJURIA_ITEMS:oxygen_mask')
AddEventHandler('LUJURIA_ITEMS:oxygen_mask', function()
...
RegisterNetEvent('LUJURIA_ITEMS:bulletproof')
AddEventHandler('LUJURIA_ITEMS:bulletproof', function()
	local playerPed = GetPlayerPed(-1)
...
RegisterNetEvent('LUJURIA_ITEMS:firstaidkit')
AddEventHandler('LUJURIA_ITEMS:firstaidkit', function()
	local playerPed = GetPlayerPed(-1)
...
RegisterNetEvent('LUJURIA_ITEMS:clipcli')
AddEventHandler('LUJURIA_ITEMS:clipcli', function()
	ped = GetPlayerPed(-1)
...
RegisterNetEvent('LUJURIA_ITEMS:startDrill')
AddEventHandler('LUJURIA_ITEMS:startDrill', function(source)
	local playerPed = GetPlayerPed(-1)
...
RegisterNetEvent('LUJURIA_ITEMS:lockpick')
AddEventHandler('LUJURIA_ITEMS:lockpick', function()
...
RegisterNetEvent('LUJURIA_ITEMS:binoculars')
AddEventHandler('LUJURIA_ITEMS:binoculars', function()
