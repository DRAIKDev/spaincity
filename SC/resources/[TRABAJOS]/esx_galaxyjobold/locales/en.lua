Locales['en'] = {
    ...
    ['galaxy_fridge_stock']       = 'Fridge of the bar galaxy',
    ['fridge_inventory']         = 'Content of the fridge',
  
    -- Shops  
    ['shop']                     = 'bar galaxy Shop',
    ...
    ['quantity']                 = 'Amount',
    ['inventory']                = 'Inventory',
    ['galaxy_stock']              = 'Stock of bar galaxy',
    ...
    -- Teleporters
    ['e_to_enter_1']             = 'Press ~INPUT_PICKUP~ to go behind the galaxy',
    ['e_to_exit_1']              = 'Press ~INPUT_PICKUP~ to go in front off the galaxy',
