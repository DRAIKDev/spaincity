            ...
            if not onDuty then
                if (GetDistanceBetweenCoords(pos, Config.Locations["main"].coords.x, Config.Locations["main"].coords.y, Config.Locations["main"].coords.z, true) < 10) then
                    ...
                    if (GetDistanceBetweenCoords(pos, Config.Locations["main"].coords.x, Config.Locations["main"].coords.y, Config.Locations["main"].coords.z, true) < 1.5) then
                        sleep = 6
                        DrawText3D(Config.Locations["main"].coords.x, Config.Locations["main"].coords.y, Config.Locations["main"].coords.z + 0.4, '~g~[E]~s~ - Ponte las ropas de trabajo.')
                        if IsControlJustPressed(0, Keys["E"]) then
                            if not InVehicle then
                                exports.rprogress:Custom({
                                    Duration = 2500,
                                    Label = "Te estás cambiando...",
                                    Animation = {
                                ...
                                exports.pNotify:SendNotification({text = "<b>Frutero</b></br>Has comenzado a trabajar!", timeout = 3000})
                                onDuty = true
                                blips()
                                end)
                            else
                                exports.pNotify:SendNotification({text = "<b>Frutero</b></br>Deja el vehiculo!", timeout = 1500})
                            end
                        end
                    end
                end
                    ...
                    if (GetDistanceBetweenCoords(pos, Config.Locations["main"].coords.x, Config.Locations["main"].coords.y, Config.Locations["main"].coords.z, true) < 1.5) then
                        ...
                        if IsControlJustPressed(0, Keys["E"]) then
                            if not InVehicle then
                                ...
                                exports.pNotify:SendNotification({text = "<b>Frutero</b></br>You finished work!", timeout = 3000})
                                onDuty = false
                                working = false
                                hasWashed = false
                                hasBox = false
                    ...
                    if (GetDistanceBetweenCoords(pos, Config.Locations["cardeposit"].coords.x, Config.Locations["cardeposit"].coords.y, Config.Locations["cardeposit"].coords.z, true) < 2.5) then
                        ...
                        if InVehicle then
                            ...
                            if IsControlJustReleased(0, Keys["E"]) then
                                if hasCar then
                                    DepositBack()
                                    exports.pNotify:SendNotification({text = '<b>Frutero</b></br>You received ' ..Config.DepositPrice.. '$ for returning the vehicle', timeout = 1500})
                                    working = false
                                    hasCar = false
                                    Plate = nil
                                    ...
                                    exports.pNotify:SendNotification({text = "<b>Frutero</b></br>You haven't paid deposit for this vehicle", timeout = 1500})
                                end
                            end
                        elseif not InVehicle then
                            ...
                            if IsControlJustReleased(0, Keys["E"]) then
                                ...
                                if hasMoney then
                                    ...
                                    exports.pNotify:SendNotification({text = '<b>Frutero</b></br>You paid ' ..Config.DepositPrice.. '$ to take out the vehicle', timeout = 1500})
                                    ...
                                    exports.pNotify:SendNotification({text = "<b>Frutero</b></br>You don't have enough money", timeout = 1500})
                                end
                                end)
                            end
                        end
            ...
            if working then
                for i, v in ipairs(Config.OrangeSpots) do
                    if not v.taked then
                        if GetDistanceBetweenCoords(pos, v.x, v.y, v.z, true) < 3 then
                            sleep = 6
                            DrawText3D(v.x, v.y, v.z + 0.4, '~g~[E]~s~ - NARANJAS')
                            if IsControlJustPressed(0, Keys["E"]) then
                                if not InVehicle then
                                    if hasBox then
                                        ...
                                        RemoveBlip(v.blip)
                                        if done == 12 then
                                            exports.pNotify:SendNotification({text = '<b>Frutero</b></br>Has cogido toda la fruta, ahora limpiala', timeout = 5000})
                                        ...
                                        exports.pNotify:SendNotification({text = "<b>Frutero</b></br>No tienes una cesta", timeout = 3000})
                                    end
                                else
                                    exports.pNotify:SendNotification({text = "<b>Frutero</b></br>Deja el vehiculo!", timeout = 1500})
                                end
                ...
                for i, v in ipairs(Config.AppleSpots) do
                    if not v.taked then
                        if GetDistanceBetweenCoords(pos, v.x, v.y, v.z, true) < 3 then
                            sleep = 6
                            DrawText3D(v.x, v.y, v.z + 0.4, '~g~[E]~s~ - MANZANAS')
                            if IsControlJustPressed(0, Keys["E"]) then
                                if not InVehicle then
                                    if hasBox then
                                        ESX.Streaming.RequestAnimDict('amb@prop_human_movie_bulb@idle_a', function()
                ...
                for i, v in ipairs(Config.StrawberrySpots) do
                    if not v.taked then
                        if GetDistanceBetweenCoords(pos, v.x, v.y, v.z, true) < 3 then
                            sleep = 6
                            DrawText3D(v.x, v.y, v.z + 0.4, '~g~[E]~s~ - FRESAS')
                            if IsControlJustPressed(0, Keys["E"]) then
                                if not InVehicle then
                                    if hasBox then
                ...
                if (GetDistanceBetweenCoords(pos, Config.Locations["transformfruit"].coords.x, Config.Locations["transformfruit"].coords.y, Config.Locations["transformfruit"].coords.z, true) < 10) then
                    ...
                    if (GetDistanceBetweenCoords(pos, Config.Locations["transformfruit"].coords.x, Config.Locations["transformfruit"].coords.y, Config.Locations["transformfruit"].coords.z, true) < 2.5) then
                        sleep = 6
                        DrawText3D(Config.Locations["transformfruit"].coords.x, Config.Locations["transformfruit"].coords.y, Config.Locations["transformfruit"].coords.z + 0.4, '~g~[E]~s~ - Limpia Fruta')
                        if IsControlJustPressed(0, Keys["E"]) then
                            if done == 12 then
                                if not InVehicle then
                                    if hasBox then
                                        ...
                                        DoScreenFadeIn(800)
                                        Citizen.Wait(800)
                                        exports.pNotify:SendNotification({text = '<b>Frutero</b></br>La fruta esta lista para vender', timeout = 5000})
                                ...
                                exports.pNotify:SendNotification({text = "<b>Frutero</b></br>Aun queda fruta en la rama!", timeout = 3000})
                            end
                        end
                    end
                end
                            ...
                            if not InVehicle then
                                if hasBox then
                                    if hasWashed then
                                        ...
                                        TriggerServerEvent('inside-fruitpicker:Payout',AmountPayout,securityToken)
                                        done = 0
                                        AmountPayout = 0
                                        hasWashed = false
                                        hasBox = false
                                        ...
                                        exports.pNotify:SendNotification({text = '<b>Frutero</b></br>La fruta no está limpia!', timeout = 3000})
                                    end
                                else
                                    exports.pNotify:SendNotification({text = "<b>Frutero</b></br>No tienes una cesta", timeout = 3000})
                                end
