Locales['es'] = {
  ...
  ['open_cloackroom'] = 'Presionar ~INPUT_CONTEXT~ para abrir su vestidor',
  ...
  ['being_searched'] = 'you are being ~y~searched~s~ by the ~b~mafia06~s~',
  ...
  ['mafia_stock'] = 'Deposito',
  
  -- Misc
  ['remove_prop'] = 'presionar ~INPUT_CONTEXT~ para eliminar el objeto',
  ['map_blip'] = 'comisaría de policía',
  ['unrestrained_timer'] = 'sientes que las esposas se aflojan.',
  
  -- Notifications
  ['alert_mafia'] = 'Alerta mafia',
  ['phone_mafia'] = 'mafia',
  ['title_gar'] = 'Garage',
  ['car_out_gar'] = 'Sacaste un ~b~vehiculo~s~ del ~y~Garage~s~!',
  ['heli_out_gar'] = 'Sacaste un ~b~Helicoptero~s~!',
  ['boat_out_gar'] = 'Sacaste un ~b~Barco~s~!',
  ['vehicle_parked'] = 'Tu vehiculo esta fuera!',
  ['no_vehicle_nearby'] = 'No tines vehiculo!',

  ['open_vehicle'] = 'presionar ~INPUT_CONTEXT~ para abrir el menú',
  ['store_vehicle'] = 'Devolver vehiculo',
  ['get_vehicle'] = 'Coger un vehiculo',
  ['vehicle_load_text'] = 'Espere que el vehiculo aparezca',
  ['vehicle_money'] = 'No dispones de suficiente dinero para sacar este vehiculo',
