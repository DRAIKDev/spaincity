Locales['cs'] = {
  ...
  ['get_rented_vehiclesvanilla']     = 'vozidla na pujceni',
  ...
  ['vehiclevanilla_sold_for']        = '~b~%s~s~ bylo ~y~prodano~s~ za ~g~$%s~s~',
  ['vehiclevanilla_sold_to']         = 'vozidlo se znackou ~y~%s~s~ bylo prodano za ~b~%s~s~',
