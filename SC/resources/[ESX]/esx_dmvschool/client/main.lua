...
function StartTheoryTest()
	...
	TriggerServerEvent('esx_dmvschool:pthay', Config.Prices['dmv'])
end
...
function StopTheoryTest(success)
	...
	if success then
		TriggerServerEvent('esx_dmvschool:addLicethnse', 'dmv')
...
function StartDriveTest(type)
	...
	TriggerServerEvent('esx_dmvschool:pthay', Config.Prices[type])
end

function StopDriveTest(success)
	if success then
		TriggerServerEvent('esx_dmvschool:addLicethnse', CurrentTestType)
		ESX.ShowNotification(_U('passed_test'))
	else
		ESX.ShowNotification(_U('failed_test'))
	end
