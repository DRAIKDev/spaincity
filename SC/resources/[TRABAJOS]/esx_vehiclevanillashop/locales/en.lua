Locales['en'] = {
  ...
  ['vehicle_belongs']         = 'El vehículo con matricula ~y~%s~s~ ahora te pertenece ~b~a tí~s~',
  ['broke_company']           = 'you do not have enough money in the company account',
  ['license_missing']         = 'you don\'t have a driver\'s license!',
  ['buy_vehicle_shop']        = '¿Quiere comprar el vehículo: %s, por $%s?',
  ...
  ['get_rented_vehiclesvanilla']     = 'vehicles for rent',
  ...
  ['paid_rental']             = 'acabas de pagar ~g~$%s~s~ for renting a vehicle with plate ~y~%s~s~',
  ...
  ['vehiclevanilla_sold_for']        = 'the ~b~%s~s~ has been ~y~sold~s~ for ~g~$%s~s~',
  ['vehiclevanilla_sold_to']         = 'the vehicle with plate ~y~%s~s~ has been sold to ~b~%s~s~',
