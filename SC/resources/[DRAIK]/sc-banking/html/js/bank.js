...
$(document).on('click','#closebanking',function(){
    $('body').fadeOut(500);
    $.post('http://sc-banking/NUIFocusOff', JSON.stringify({}));
})

$(document).on('click','#withdraw',function(e){
    e.preventDefault();
    $.post('http://sc-banking/withdraw', JSON.stringify({
...
$(document).on('click','#depositarpasta',function(e){
    e.preventDefault();
    $.post('http://sc-banking/deposit', JSON.stringify({
...
$(document).on('click','#transferirpasta',function(e){
    e.preventDefault();
    $.post('http://sc-banking/transfer', JSON.stringify({
