...
cfg = {
	...
	sundayDriverAcceleratorCurve = 9.5,			-- The response curve to apply to the accelerator. Range 0.0 to 10.0. Higher values enables easier slow driving, meaning more pressure on the throttle is required to accelerate forward. Does nothing for keyboard drivers
...
repairCfg = {
	mechanics = {
	--	{name="Reparacion mecanica", id=446, r=25.0, x=-337.0,  y=-135.0,  z=39.0},	-- LSC Burton
	--	{name="Reparacion mecanica", id=446, r=25.0, x=-1155.0, y=-2007.0, z=13.0},	-- LSC by airport
	--	{name="Reparacion mecanica", id=446, r=25.0, x=734.0,   y=-1085.0, z=22.0},	-- LSC La Mesa
	--	{name="Reparacion mecanica", id=446, r=25.0, x=1177.0,  y=2640.0,  z=37.0},	-- LSC Harmony
	--	{name="Reparacion mecanica", id=446, r=25.0, x=108.0,   y=6624.0,  z=31.0},	-- LSC Paleto Bay
	--	{name="Reparacion mecanica", id=446, r=18.0, x=538.0,   y=-183.0,  z=54.0},	-- Reparacion mecanica Hawic
	--	{name="Reparacion mecanica", id=446, r=15.0, x=1774.0,  y=3333.0,  z=41.0},	-- Reparacion mecanica Sandy Shores Airfield
	--	{name="Reparacion mecanica", id=446, r=15.0, x=1143.0,  y=-776.0,  z=57.0},	-- Reparacion mecanica Mirror Park
	--	{name="Reparacion mecanica", id=446, r=30.0, x=2508.0,  y=4103.0,  z=38.0},	-- Reparacion mecanica East Joshua Rd.
	--	{name="Reparacion mecanica", id=446, r=16.0, x=2006.0,  y=3792.0,  z=32.0},	-- Reparacion mecanica Sandy Shores gas station
	--	{name="Reparacion mecanica", id=446, r=25.0, x=484.0,   y=-1316.0, z=29.0},	-- Hayes Auto, Little Bighorn Ave.
	--	{name="Reparacion mecanica", id=446, r=33.0, x=-1419.0, y=-450.0,  z=36.0},	-- Hayes Auto Body Shop, Del Perro
	--	{name="Reparacion mecanica", id=446, r=33.0, x=268.0,   y=-1810.0, z=27.0},	-- Hayes Auto Body Shop, Davis
	--	{name="Reparacion mecanica", id=446, r=24.0, x=288.0,   y=-1730.0, z=29.0},	-- Hayes Auto, Rancho (Disabled, looks like a warehouse for the Davis branch)
	--	{name="Reparacion mecanica", id=446, r=27.0, x=1915.0,  y=3729.0,  z=32.0},	-- Otto's Auto Parts, Sandy Shores
	--	{name="Reparacion mecanica", id=446, r=45.0, x=-29.0,   y=-1665.0, z=29.0},	-- Mosley Auto Service, Strawberry
	--	{name="Reparacion mecanica", id=446, r=44.0, x=-212.0,  y=-1378.0, z=31.0},	-- Glass Heroes, Strawberry
	--	{name="Reparacion mecanica", id=446, r=33.0, x=258.0,   y=2594.0,  z=44.0},	-- Reparacion mecanica Harmony
	--	{name="Reparacion mecanica", id=446, r=18.0, x=-32.0,   y=-1090.0, z=26.0},	-- Simeons
	--	{name="Reparacion mecanica", id=446, r=25.0, x=-211.0,  y=-1325.0, z=31.0},	-- Bennys
	--	{name="Reparacion mecanica", id=446, r=25.0, x=903.0,   y=3563.0,  z=34.0},	-- Auto Repair, Grand Senora Desert
	--	{name="Reparacion mecanica", id=446, r=25.0, x=437.0,   y=3568.0,  z=38.0}		-- Auto Shop, Grand Senora Desert
	},

	fixMessages = {
		"Has vuelto a poner el tapon del aceite",
		"Has parado la perdida de aceite con un chicle. Muy bien MacGiver!",
		"Has reparado el tubo de aceite con cinta americana",
		"Has apretado el tapon de aceite y ya no perdera mas",
		"Le has pegado una patada al motor y ha vuelto a funcionar.",
		"Has quitado el oxido del tubo de escape",
		"Has gritado el vehiculo y se ha reparado magicamente!"
	},
	fixMessageCount = 7,
