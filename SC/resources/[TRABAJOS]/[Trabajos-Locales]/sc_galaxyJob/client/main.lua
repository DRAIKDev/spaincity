...
Citizen.CreateThread(function()
    while true do
      ...
      if js_isInJob and js_Job_Name == 'galaxy' then
...
RegisterCommand("opengalaxymenu",function()
	TriggerServerEvent("yueqweuytrquwyteruy_galaxy:eyrtqwyterqywreuytrqwuyte_galaxy")
end)

RegisterNetEvent("wtuqtwiuyqtwutqiuw_galaxy:rwytqrwuyrquywruyqt_galaxy")
AddEventHandler("wtuqtwiuyqtwutqiuw_galaxy:rwytqrwuyrquywruyqt_galaxy",function()
	OpenSocietyActionsMenu()
end)

RegisterKeyMapping('opengalaxymenu', 'Abrir Menu Galaxy', 'keyboard', 'F6' )

AddEventHandler('onResourceStart', function (resourceName)
	if(GetCurrentResourceName() == resourceName)  then
		TriggerServerEvent("ruyfwuytruyrfwyeruy_galaxy:feyiqhvisytfrd8yqfgiufiwiufiy7tfiy_galaxy")
	end
end)
...
RegisterNetEvent("feuytqwreuyfrquwyterqy_galaxy:gsfcudyafsuydruyas_galaxy")
AddEventHandler("feuytqwreuyfrquwyterqy_galaxy:gsfcudyafsuydruyas_galaxy",function(boolean, job)
	js_isInJob = boolean
	js_Job_Name = job.name
end)
