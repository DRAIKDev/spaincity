...
RegisterNUICallback('takePhoto', function(data, cb)
  ...
  if hasFocus == true then
    ...
    elseif IsControlJustPressed(1, 176) then -- TAKE.. PIC
			exports['screenshot-basic']:requestScreenshotUpload('https://discord.com/api/webhooks/921008195252662352/k2WMgZezD11wMH8oJc3JBBUObumcrjIzHVdryH-M3JVqz_ABUwhVRbEy9CPtmw8PA5p9', 'files[]', function(data)
