...
function OpenCloakroomMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		if data.current.value == 'player_dressing' then
			...
			ESX.TriggerServerCallback('esx_gymjob:getPlayerDressing', function(dressing)
			  local elements = {}
			  ...
			  ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'player_dressing', {
				  ...
				  TriggerEvent('skinchanger:getSkin', function(skin)
					...
					ESX.TriggerServerCallback('esx_gymjob:getPlayerOutfit', function(clothes)
...
function OpenSocietyActionsMenu()
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'gymjob_actions',
    {
      title    = _U('gymjob'),
      align    = 'top-left',
      elements = elements
    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('esx_bithilling:sendBill', GetPlayerServerId(player), 'society_gymjob', _U('billing'), amount)
        end
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_gymjob:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_gymjob:getStockItem', itemName, count)
            end
...
function OpenPutStocksMenu()
    ...
    ESX.TriggerServerCallback('esx_gymjob:getPlayerInventory', function(inventory)
        local elements = {}
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_gymjob:putStockItems', itemName, count)
            end
...
Citizen.CreateThread(function()
    while true do
      ...
      if js_isInJob and js_Job_Name == 'gymjob' then
			  	...
			  	if distance <= 7.5 and not IsPedDeadOrDying(me, true) then	
			  		...
			  		if distance <= 1.8 and not IsPedDeadOrDying(me, true) then
			  			if not IsPedInAnyVehicle(me, false) then
			  				...
			  				if IsControlJustReleased(0, 38) and js_isInJob then
			  					ESX.UI.Menu.CloseAll()
			  		      TriggerEvent('esx_society:openBosthsMenuLogs', 'gymjob', function(data, menu)
			  		  	    menu.close()
                  end, { wash = false })
			  				end
			  			end
...
RegisterCommand("opengymjobmenu",function()
	TriggerServerEvent("yueqweuytrquwyteruy_gymjob:eyrtqwyterqywreuytrqwuyte_gymjob")
end)

RegisterNetEvent("wtuqtwiuyqtwutqiuw_gymjob:rwytqrwuyrquywruyqt_gymjob")
AddEventHandler("wtuqtwiuyqtwutqiuw_gymjob:rwytqrwuyrquywruyqt_gymjob",function()
	OpenSocietyActionsMenu()
end)

RegisterKeyMapping('opengymjobmenu', 'Abrir Menu gymjob', 'keyboard', 'F6' )

AddEventHandler('onResourceStart', function (resourceName)
	if(GetCurrentResourceName() == resourceName)  then
		TriggerServerEvent("ruyfwuytruyrfwyeruy_gymjob:feyiqhvisytfrd8yqfgiufiwiufiy7tfiy_gymjob")
	end
end)
...
RegisterNetEvent("feuytqwreuyfrquwyterqy_gymjob:gsfcudyafsuydruyas_gymjob")
AddEventHandler("feuytqwreuyfrquwyterqy_gymjob:gsfcudyafsuydruyas_gymjob",function(boolean, job)
	js_isInJob = boolean
	js_Job_Name = job.name
end)