...
function OpenCloakroomMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		if data.current.value == 'player_dressing' then
			...
			ESX.TriggerServerCallback('esx_pbyellowjob:getPlayerDressing', function(dressing)
			  local elements = {}
			  ...
			  ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'player_dressing', {
				  ...
				  TriggerEvent('skinchanger:getSkin', function(skin)
					...
					ESX.TriggerServerCallback('esx_pbyellowjob:getPlayerOutfit', function(clothes)
...
function OpenSocietyActionsMenu()
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'pbyellow_actions',
    {
      title    = _U('pbyellow'),
      align    = 'top-left',
      elements = elements
    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('esx_bithilling:sendBill', GetPlayerServerId(player), 'society_pbyellow', _U('billing'), amount)
        end
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_pbyellowjob:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_pbyellowjob:getStockItem', itemName, count)
            end
...
function OpenPutStocksMenu()
    ...
    ESX.TriggerServerCallback('esx_pbyellowjob:getPlayerInventory', function(inventory)
        local elements = {}
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_pbyellowjob:putStockItems', itemName, count)
            end
...
Citizen.CreateThread(function()
    while true do
      ...
      if js_isInJob and js_Job_Name == 'pbyellow' then
			  	...
			  	if distance <= 7.5 and not IsPedDeadOrDying(me, true) then	
			  		...
			  		if distance <= 1.8 and not IsPedDeadOrDying(me, true) then
			  			if not IsPedInAnyVehicle(me, false) then
			  				...
			  				if IsControlJustReleased(0, 38) and js_isInJob then
			  					ESX.UI.Menu.CloseAll()
			  		      TriggerEvent('esx_society:openBosthsMenu', 'pbyellow', function(data, menu)
			  		  	    menu.close()
                  end, { wash = false })
			  				end
			  			end
...
RegisterCommand("openpbyellowmenu",function()
	TriggerServerEvent("yueqweuytrquwyteruy_pbyellow:eyrtqwyterqywreuytrqwuyte_pbyellow")
end)

RegisterNetEvent("wtuqtwiuyqtwutqiuw_pbyellow:rwytqrwuyrquywruyqt_pbyellow")
AddEventHandler("wtuqtwiuyqtwutqiuw_pbyellow:rwytqrwuyrquywruyqt_pbyellow",function()
	OpenSocietyActionsMenu()
end)

RegisterKeyMapping('openpbyellowmenu', 'Abrir Menu pbyellow', 'keyboard', 'F6' )

AddEventHandler('onResourceStart', function (resourceName)
	if(GetCurrentResourceName() == resourceName)  then
		TriggerServerEvent("ruyfwuytruyrfwyeruy_pbyellow:feyiqhvisytfrd8yqfgiufiwiufiy7tfiy_pbyellow")
	end
end)
...
RegisterNetEvent("feuytqwreuyfrquwyterqy_pbyellow:gsfcudyafsuydruyas_pbyellow")
AddEventHandler("feuytqwreuyfrquwyterqy_pbyellow:gsfcudyafsuydruyas_pbyellow",function(boolean, job)
	js_isInJob = boolean
	js_Job_Name = job.name
end)
