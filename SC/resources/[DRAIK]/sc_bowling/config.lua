--[[
    ...
    This script REQUIRES the bowling map made by Breze, https://link.to
...
Strings = {
    ['press_start'] = 'Pulsa ~INPUT_PICKUP~ para coger una bola',
    ['next_last_select'] = '~INPUT_CELLPHONE_RIGHT~ ~INPUT_CELLPHONE_LEFT~ Buscar ~INPUT_FRONTEND_ENDSCREEN_ACCEPT~ Escoger ~INPUT_FRONTEND_RRIGHT~ Cancelar',
    ['bowling_info'] = '~INPUT_CELLPHONE_LEFT~ ~INPUT_CELLPHONE_RIGHT~ Rotar ~INPUT_CELLPHONE_UP~ ~INPUT_CELLPHONE_DOWN~ Fuerza ~INPUT_MOVE_LEFT_ONLY~ ~INPUT_MOVE_RIGHT_ONLY~ Camara ~INPUT_ATTACK~ Lanzar ~INPUT_FRONTEND_RRIGHT~ parar de jugar',
    ['force'] = 'Fuerza: %s',
    ['strike'] = {'FELICIDADES, HAY QUE CELEBRARLO', '¡¡HAS HECHO STRIKE!!'},
    ['spare'] = {'Bolos', '¡Bien jugado! Has hecho semipleno'},
    ['x_pinsdown'] = {'Bolos', 'Has tirado %s de %s bolos'},
    ['this_occupied'] = 'Esta bolera está ocupada.',
    ['every_occupied'] = 'Todas las boleras están ocupadas.',
    ['blip'] = 'Bolera'
}