...
Config.MarkerType                 = {Cloakrooms = 20, Armories = 20, BossActions = 22, Vehicles = 36, Helicopters = 34}
...
Config.policeStations = {
	...
	LSPD = {
		...
		Blip = {
			Coords  = vector3(1855.990, 3695.581, 34.270),
			Sprite  = 58,
			Display = 3,
			Scale   = 0.9,
			Colour  = 29
...
Config.Uniforms = {
	practicas = {
		male = {
			...
			chain_1 = 152,    chain_2 = 0,

		},
		female = {
			tshirt_1 = 35,  tshirt_2 = 0,
			torso_1 = 494,   torso_2 = 0,
			decals_1 = 0,   decals_2 = 0,
			arms = 44,
