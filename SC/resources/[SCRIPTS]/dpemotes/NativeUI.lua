...
function UIMenuItem.New(Text, Description)
    _UIMenuItem = {
        ...
        SelectedSprite = Sprite.New("WS_commonmenu", "gradient_nav", 0, 0, 431, 38),
        LeftBadge = { Sprite = Sprite.New("WS_commonmenu", "", 0, 0, 40, 40), Badge = 0},
        RightBadge = { Sprite = Sprite.New("WS_commonmenu", "", 0, 0, 40, 40), Badge = 0},
        Label = {
...
function UIMenuCheckboxItem.New(Text, Check, Description)
    local _UIMenuCheckboxItem = {
        ...
        CheckedSprite = Sprite.New("WS_commonmenu", "shop_box_blank", 410, 95, 50, 50),
...
function UIMenuListItem.New(Text, Items, Index, Description)
    ...
    local _UIMenuListItem = {
        Base = UIMenuItem.New(Text or "", Description or ""),
        Items = Items,
        LeftArrow = Sprite.New("WS_commonmenu", "arrowleft", 110, 105, 30, 30),
        RightArrow = Sprite.New("WS_commonmenu", "arrowright", 280, 105, 30, 30),
...
function UIMenuGridPanel.New(TopText, LeftText, RightText, BottomText)
    _UIMenuGridPanel = {
        ...
        Background = Sprite.New("WS_commonmenu", "gradient_bgd", 0, 0, 431, 275),
...
function UIMenuColourPanel.New(Title, Colours)
    _UIMenuColourPanel = {
        ...
        Background = Sprite.New("WS_commonmenu", "gradient_bgd", 0, 0, 431, 112),
        Bar = {},
        LeftArrow = Sprite.New("WS_commonmenu", "arrowleft", 0, 0, 30, 30),
        RightArrow = Sprite.New("WS_commonmenu", "arrowright", 0, 0, 30, 30),
...
function UIMenuPercentagePanel.New(MinText, MaxText)
    _UIMenuPercentagePanel = {
        ...
        Background = Sprite.New("WS_commonmenu", "gradient_bgd", 0, 0, 431, 76),
...
function UIMenu.New(Title, Subtitle, X, Y, TxtDictionary, TxtName)
    ...
    if TxtDictionary ~= nil then TxtDictionary = tostring(TxtDictionary) or "WS_commonmenu" else TxtDictionary = "WS_commonmenu" end
    ...
    _UIMenu.ArrowSprite = Sprite.New("WS_commonmenu", "shop_arrows_upanddown", 190 + _UIMenu.Position.X, 147 + 37 * (_UIMenu.Pagination.Total + 1) + _UIMenu.Position.Y - 37 + _UIMenu.Subtitle.ExtraY, 50, 50)
    ...
    _UIMenu.Description.Rectangle = Sprite.New("WS_commonmenu", "gradient_bgd", _UIMenu.Position.X, 127, 431, 30)
    _UIMenu.Description.Text = UIResText.New("Description", _UIMenu.Position.X + 5, 125, 0.35)

    _UIMenu.Background = Sprite.New("WS_commonmenu", "gradient_bgd", _UIMenu.Position.X, 144 + _UIMenu.Position.Y - 37 + _UIMenu.Subtitle.ExtraY, 290, 25)
