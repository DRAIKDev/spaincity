...
function OpenCloakroomMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		if data.current.value == 'player_dressing' then
			...
			ESX.TriggerServerCallback('esx_pbdiscotecajob:getPlayerDressing', function(dressing)
			  local elements = {}
			  ...
			  ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'player_dressing', {
				  ...
				  TriggerEvent('skinchanger:getSkin', function(skin)
					...
					ESX.TriggerServerCallback('esx_pbdiscotecajob:getPlayerOutfit', function(clothes)
...
function OpenSocietyActionsMenu()
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'pbdiscoteca_actions',
    {
      title    = _U('pbdiscoteca'),
      align    = 'top-left',
      elements = elements
    },
    function(data, menu)
    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('esx_bithilling:sendBill', GetPlayerServerId(player), 'society_pbdiscoteca', _U('billing'), amount)
        end
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_pbdiscotecajob:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_pbdiscotecajob:getStockItem', itemName, count)
            end
...
function OpenPutStocksMenu()
    ...
    ESX.TriggerServerCallback('esx_pbdiscotecajob:getPlayerInventory', function(inventory)
        local elements = {}
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_pbdiscotecajob:putStockItems', itemName, count)
            end
...
Citizen.CreateThread(function()
    while true do
      ...
      if js_isInJob and js_Job_Name == 'pbdiscoteca' then
			  	...
			  	if distance <= 7.5 and not IsPedDeadOrDying(me, true) then	
			  		...
			  		if distance <= 1.8 and not IsPedDeadOrDying(me, true) then
			  			if not IsPedInAnyVehicle(me, false) then
			  				...
			  				if IsControlJustReleased(0, 38) and js_isInJob then
			  					ESX.UI.Menu.CloseAll()
			  		      TriggerEvent('esx_society:openBosthsMenu', 'pbdiscoteca', function(data, menu)
			  		  	    menu.close()
                  end, { wash = false })
			  				end
			  			end
...
RegisterCommand("openpbdiscotecamenu",function()
	TriggerServerEvent("yueqweuytrquwyteruy_pbdiscoteca:eyrtqwyterqywreuytrqwuyte_pbdiscoteca")
end)

RegisterNetEvent("wtuqtwiuyqtwutqiuw_pbdiscoteca:rwytqrwuyrquywruyqt_pbdiscoteca")
AddEventHandler("wtuqtwiuyqtwutqiuw_pbdiscoteca:rwytqrwuyrquywruyqt_pbdiscoteca",function()
	OpenSocietyActionsMenu()
end)

RegisterKeyMapping('openpbdiscotecamenu', 'Abrir Menu Discoteca', 'keyboard', 'F6' )

AddEventHandler('onResourceStart', function (resourceName)
	if(GetCurrentResourceName() == resourceName)  then
		TriggerServerEvent("ruyfwuytruyrfwyeruy_pbdiscoteca:feyiqhvisytfrd8yqfgiufiwiufiy7tfiy_pbdiscoteca")
	end
end)
...
RegisterNetEvent("feuytqwreuyfrquwyterqy_pbdiscoteca:gsfcudyafsuydruyas_pbdiscoteca")
AddEventHandler("feuytqwreuyfrquwyterqy_pbdiscoteca:gsfcudyafsuydruyas_pbdiscoteca",function(boolean, job)
	js_isInJob = boolean
	js_Job_Name = job.name
end)
