Locales['es'] = {
  ...
  ['license_check'] = 'Mirar licencias',
  ['license_revoke'] = 'Eliminar licencias',
  ...
  ['being_searched'] = 'Estas siendo ~y~cacheado~s~ por la ~b~CNP~s~',
  -- Vehicle interaction
  ...
  ['impound_prompt'] = 'Presiona ~INPUT_CONTEXT~ para cancelar la incautación.',
  ...
  ['search_database'] = 'Buscar matricula',
  ['search_database_title'] = 'Buscar matricula',
  ...
  -- Vehicle Info Menu
  ['plate'] = 'n°: %s',
  ['owner_unknown'] = 'Propietario: Sin datos conocidos.',
  ['owner'] = 'propietario: %s',
  -- Boss Menu
