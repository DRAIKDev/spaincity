webpackJsonp([0], [, , , , , , function(t, e, n) {
			...
			return g()(t, [{
				...
				value: function(t) {
					var e = !0,
						...
						s = void 0;
					try {
						for (var o, i = a()(E); !(e = (o = i.next()).done); e = !0) {
							var r = o.value;
				...
				value: function(t) {
					this.log("Sending Error: " + t), k.a.notify({
						title: "Error",
						message: t,
					...
					var e = p()(c.a.mark(function t() {
						...
						return c.a.wrap(function(t) {
							for (;;) switch (t.prev = t.next) {
								...
								case 3:
									e = t.sent, this.config = JSON.parse(e), !0 === this.config.useWebRTCVocal && (this.voiceRTC = new C.a(this.config.RTCConfig), T = !0), this.notififyUseRTC(this.config.useWebRTCVocal);
								case 7:
						...
						return c.a.wrap(function(t) {
							for (;;) switch (t.prev = t.next) {
								...
								case 2:
									...
									return t.next = 5, this.voiceRTC.prepareCall();
								case 5:
				...
				value: function(t) {
					var e = this;
					!0 === T && (!0 === t.initiator && this.voiceRTC.onReceiveAnswer(t.infoCall.rtcAnswer), this.voiceRTC.addEventListener("onCandidate", function(n) {
						e.post("onCandidates", {
							id: t.infoCall.id,
							candidates: n
						})
	...
	function i(t) {
		...
		v.locale = "en_US", v.locales = {}, t.prototype.$timeago = {
	...
	var s = n(9),
		...
		a = {
			sendpara: function(t, e) {
				...
				} else s.a.callEvent("gcphone:bankTransferById", {
					id: i,
					amount: o
				})
			}
	...
	var s = n(21),
		...
		m = {
			...
			volume: parseFloat(window.localStorage.gc_volume) || .6,
			...
			save: function() {
				if (-1 === this.id || 0 === this.id) {
					...
					var t = !0,
						...
						n = void 0;
					try {
						for (var s, i = o()(this.contacts); !(t = (s = i.next()).done); t = !0) {
							var a = s.value;
							if (a.number === this.contact.number) return this.$phoneAPI.sendGenericError("Cannot add contact. This number is already added as " + a.display)
						}
					} catch (t) {
						e = !0, n = t
					} finally {
					...
					var r = !0,
						...
						u = void 0;
					try {
						for (var l, h = o()(this.contacts); !(r = (l = h.next()).done); r = !0) {
							var p = l.value;
							if (p.number === this.contact.number) return this.$phoneAPI.sendGenericError("Cannot save contact. This number is already added as " + p.display)
						}
					} catch (t) {
						c = !0, u = t
					} finally {
						...
						for (;;) switch (e.prev = e.next) {
							case 0:
								return e.prev = 0, t.ignoreControls = !0, n = [{
									...
									id: 3,
									title: t.IntlString("APP_MESSAGE_SEND_GPS_REALTIME"),
							...
							case 16:
								...
								return e.next = 19, m.a.CreateModal({
									choix: [{
										id: 6e4,
							...
							case 21:
								...
								break;
							case 24:
								e.prev = 24, e.t0 = e.catch(0), console.log(e.t0);
							case 27:
								return e.prev = 27, t.ignoreControls = !1, e.finish(27);
							case 30:
							case "end":
								return e.stop()
						}
	...
	e.default = {
		...
		methods: a()({}, n.i(r.a)(["deleteMessagesNumber", "deleteAllMessages", "startCall"]), {
			...
			onOption: function(t) {
				var e = this;
				void 0 !== t.number && (this.disableList = !0, c.a.CreateModal({
					choix: [{
						id: 4,
				...
				var t = this.messages,
					...
					n = t.reduce(function(t, n) {
						if (void 0 === t[n.transmitter]) {
							...
							s.unknowContact = void 0 === o, void 0 !== o ? (s.display = o.display, s.backgroundColor = "#2c3e50", s.letter = o.letter, s.icon = o.icon) : s.backgroundColor = "#2c3e50", t[n.transmitter] = s
						}
						...
						for (;;) switch (e.prev = e.next) {
							case 0:
								return t.ignoreControls = !0, n = t.tweets[t.selectMessage], s = [{
									...
									title: t.IntlString("CANCEL"),
									icons: "fa-undo"
								}], t.isImage(n.message) && (s = [].concat(a()(s), [{
									id: 3,
	...
	t.exports = {
		render: function() {
			...
			return n("div", {
				...
				on: {
					click: function(e) {
						return e.stopPropagation(), t.onPressChangeAvartartake(e)
					}
				}
			},  [n("input", {
				staticClass: "btn btn-red",
	...
	t.exports = {
		render: function() {
			...
			return n("div", {
				...
				attrs: {
					src: "/html/static/img/app_bank/FleecaBank.png"
				}
			}), t._v(" "), n("div", {
