Locales['br'] = {
  ...
  ['get_rented_vehiclesvanilla']     = 'veículos para alugar',
  ...
  ['vehiclevanilla_sold_for']        = 'o ~b~%s~s~ foi vendido com sucesso para ~g~$%s~s~',
  ['vehiclevanilla_sold_to']         = 'Veículo ~y~%s~s~ vendido para ~b~%s~s~',
