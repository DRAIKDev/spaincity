...
RegisterCommand("cargar",function(source, args)
	if not carryingBackInProgress then
		...
		if closestPlayer ~= -1 and closestPlayer ~= nil then
			...
			TriggerServerEvent('CarryPeople:sync', closestPlayer, target,lib,lib2, anim1, anim2, distans, distans2, height,target,length,spin,controlFlagMe,controlFlagTarget,animFlagTarget)
		else
