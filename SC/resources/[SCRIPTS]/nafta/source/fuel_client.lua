...
if Config.EnableHUD then
	...
	Citizen.CreateThread(function()
		while true do
			if displayHud then
				DrawAdvancedText(0.298 - x, 0.8665 - y, 0.003, 0.0048, 0.4, fuel, 255, 255, 255, 255, 6, 1)
				DrawAdvancedText(0.278 - x, 0.8665 - y, 0.003, 0.0048, 0.4, "~r~Nafta: ", 255, 255, 255, 255, 6, 1)
			else
				Citizen.Wait(750)
			end
