...
AddEventHandler(
  ...
  function(zone)
    ...
    -- CNP --
    if zone == "CNPDuty" or zone == "CNIDuty" then
    ...
    if zone == "Mechanic01Duty" then
      CurrentAction = "mechanic01_duty"
      CurrentActionMsg = _U("duty")
      CurrentActionData = {}
    end

    if zone == "Mechanic02Duty" then
      CurrentAction = "mechanic02_duty"
      CurrentActionMsg = _U("duty")
      CurrentActionData = {}
    end
    ...
    if zone == "BaducentralDuty" then
      CurrentAction = "baducentral_duty"
      CurrentActionMsg = _U("duty")
      CurrentActionData = {}
    end

    if zone == "BadunorteDuty" then
      CurrentAction = "badunorte_duty"
      CurrentActionMsg = _U("duty")
      CurrentActionData = {}
    end

    if zone == "BadusandyDuty" then
      CurrentAction = "badusandy_duty"
      CurrentActionMsg = _U("duty")
      CurrentActionData = {}
    end
    ...
    -- MAFIAS --
      ...
      if zone == "Mafia01Duty2" then
        CurrentAction = "mafia01_galaxy_duty"
        CurrentActionMsg = _U("duty")
        CurrentActionData = {}
      end
      ...
      if zone == "Mafia02Duty2" then
        CurrentAction = "mafia02_badusandy_duty"
        CurrentActionMsg = _U("duty")
        CurrentActionData = {}
      end
      ...
      while true do
          ...
          if CurrentAction ~= nil then
            ...
            if IsControlPressed(0, Keys["E"]) then
                ...
                if CurrentAction == "mechanic01_duty" then
                    if PlayerData.job.name == "mechanic01" or PlayerData.job.name == "offmechanic01" then
                        TriggerServerEvent("duty:mechanic01")
                        if PlayerData.job.name == "mechanic01" then
                            sendNotification(_U("offduty"), "success", 2500)
                            Wait(1000)
                        else
                            sendNotification(_U("onduty"), "success", 2500)
                ...
                if CurrentAction == "mechanic02_duty" then
                    if PlayerData.job.name == "mechanic02" or PlayerData.job.name == "offmechanic02" then
                        TriggerServerEvent("duty:mechanic02")
                        if PlayerData.job.name == "mechanic02" then
                            sendNotification(_U("offduty"), "success", 2500)
                            Wait(1000)
                        else
                            sendNotification(_U("onduty"), "success", 2500)
                ...
                if CurrentAction == "baducentral_duty" then
                    if PlayerData.job.name == "baducentral" or PlayerData.job.name == "offbaducentral" then
                        TriggerServerEvent("duty:baducentral")
                        if PlayerData.job.name == "baducentral" then
                            sendNotification(_U("offduty"), "success", 2500)
                            Wait(1000)
                        else
                            sendNotification(_U("onduty"), "success", 2500)
                ...
                if CurrentAction == "badunorte_duty" then
                    if PlayerData.job.name == "badunorte" or PlayerData.job.name == "offbadunorte" then
                        TriggerServerEvent("duty:badunorte")
                        if PlayerData.job.name == "badunorte" then
                            sendNotification(_U("offduty"), "success", 2500)
                            Wait(1000)
                        else
                            sendNotification(_U("onduty"), "success", 2500)
                ...
                if CurrentAction == "badusandy_duty" then
                    if PlayerData.job.name == "badusandy" or PlayerData.job.name == "offbadusandy" then
                        TriggerServerEvent("duty:badusandy")
                        if PlayerData.job.name == "badusandy" then
                            sendNotification(_U("offduty"), "success", 2500)
                            Wait(1000)
                        else
                            sendNotification(_U("onduty"), "success", 2500)
                ...
                -- MAFIAS --
                    ...
                    if CurrentAction == "mafia01_galaxy_duty" then
                        if PlayerData.job.name == "mafia01" or PlayerData.job.name == "offgalaxy" then
                            TriggerServerEvent("duty:mafia01_galaxy")
                            if PlayerData.job.name == "offgalaxy" then
                                sendNotification(_U("offduty"), "success", 2500)
                                Wait(1000)
                            else
                                sendNotification(_U("onduty"), "success", 2500)
                    ...
                    if CurrentAction == "mafia02_badusandy_duty" then
                        if PlayerData.job.name == "mafia02" or PlayerData.job.name == "offbadusandy" then
                            TriggerServerEvent("duty:mafia02_badusandy")
                            if PlayerData.job.name == "offbadusandy" then
                                sendNotification(_U("offduty"), "success", 2500)
                                Wait(1000)
                            else
                                sendNotification(_U("onduty"), "success", 2500)
