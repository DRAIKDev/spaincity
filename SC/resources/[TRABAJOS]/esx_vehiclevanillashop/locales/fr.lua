Locales['fr'] = {
  ...
  ['get_rented_vehiclesvanilla']             = 'véhicules en location',
  ...
  ['vehiclevanilla_sold_for']                = 'le ~b~%s~s~ a été ~y~vendu~s~ pour ~g~$%s~s~',
  ['vehiclevanilla_sold_to']                 = 'véhicule ~y~%s~s~ vendu à ~b~%s~s~',
