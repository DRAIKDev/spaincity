...
ESX.RegisterUsableItem('oxygen_mask', function(source)
	TriggerClientEvent('LUJURIA_ITEMS:oxygen_mask', source)
	local xPlayer  = ESX.GetPlayerFromId(source)
...
ESX.RegisterUsableItem('bulletproof', function(source)
	local xPlayer = ESX.GetPlayerFromId(source)
	TriggerClientEvent('LUJURIA_ITEMS:bulletproof', source)
...
ESX.RegisterUsableItem('firstaidkit', function(source)
	local xPlayer = ESX.GetPlayerFromId(source)
	TriggerClientEvent('LUJURIA_ITEMS:firstaidkit', source)
...
ESX.RegisterUsableItem('clip', function(source)
	local xPlayer = ESX.GetPlayerFromId(source)
	TriggerClientEvent('LUJURIA_ITEMS:clipcli', source)
...
ESX.RegisterUsableItem('drill', function(source)
    local xPlayer = ESX.GetPlayerFromId(source)
    TriggerClientEvent('LUJURIA_ITEMS:startDrill', source)
...
ESX.RegisterUsableItem('lockpick', function(source)
	local xPlayer = ESX.GetPlayerFromId(source)
	TriggerClientEvent('LUJURIA_ITEMS:lockpick', _source)
...
ESX.RegisterUsableItem('binoculars', function(source)
	local xPlayer = ESX.GetPlayerFromId(source)
	TriggerClientEvent('LUJURIA_ITEMS:binoculars', source)
end)
