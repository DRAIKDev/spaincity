Locales['en'] = {
  ...
  ['vehicle_belongs']         = 'Un vehiculo con la patente ~y~%s~s~ ahora te ~b~pertenece~s~',
  ['broke_company']           = 'No tenes suficiente dinero en tu compania',
  ['license_missing']         = 'No tenes licencia de conducir!',
  ['purchase_type']           = 'Tipo de compra',
  ['society_type']            = 'Sociedad',
  ['staff_type']              = 'Uso personal',
  ['buy_vehicle_shop']        = 'Querer comprar %s por $%s?',
  ['buy_vehicle']             = 'Comprar vehiculo',
  ['car_dealer']              = 'Concesionario Deluxe',
  ...
  ['depop_vehicle']           = 'Recuperar vehiculo',
  ['return_provider']         = 'Deovolver vehiculo al proveedor',
