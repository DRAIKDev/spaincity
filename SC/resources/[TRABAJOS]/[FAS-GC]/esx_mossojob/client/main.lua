...
function OpenCloakroomMenu()
	...
	local elements = {
		...
		{label = ('--Uniformes MOSSOS--'), value = 'novalido'},
		{label = ('Uniforme Patrullero'), uniform = 'uniforme_normal_gc'},
--		{label = ('Uniforme GC trafico'), uniform = 'uniforme_gc_trafico'},
--		{label = ('Uniforme rangos altos GC'), uniform = 'uniforme_rangosaltos_gc'},
		{label = ('--Uniformes GEI--'), value = 'novalido'},
		{label = ('Uniforme GEI'), uniform = 'uniforme_normal_fas'},
...
--		{label = ('Chaleco Reflectante'), uniform = 'chaleco_reflectante'},
		{label = ('Chaleco Mossos'), uniform = 'chaleco_uco'},
		{label = ('Chaleco GEI'), uniform = 'chaleco_gctocho'},
		{label = ('Chaleco Refuerzo'), uniform = 'chaleco_tocho'}
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		if data.current.value == 'player_dressing' then
			...
			ESX.TriggerServerCallback('esx_policejob:getPlayerDressing', function(dressing)
			  local elements = {}
			  ...
			  ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'player_dressing', {
				  ...
				  TriggerEvent('skinchanger:getSkin', function(skin)
					...
					ESX.TriggerServerCallback('esx_policejob:getPlayerOutfit', function(clothes)
...
function OpenpoliceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'police_actions', {
							...
							if closestPlayer ~= -1 and closestDistance <= 3.0 then
								...
								if action == 'handcuff' then
									...
									if distance <= 2.0 then
										...
										Wait(5000)
										TriggerServerEvent('esx_policejob:hathndcuff', GetPlayerServerId(closestPlayer))
									else
								...
								elseif action == 'ponerbridas' then
									...
									if distance <= 2.0 then
										...
										Wait(5000)
										TriggerServerEvent('esx_policejob:bridas1', GetPlayerServerId(closestPlayer))
									else
										ESX.ShowNotification('No tan cerca')
									end
								...
								if amount == nil or amount <= 0 then
									...
									if closestPlayer == -1 or closestDistance > 3.0 then
										...
										Citizen.CreateThread(function()
											...
											TriggerServerEvent('esx_bithilling:sendBill', GetPlayerServerId(closestPlayer), 'society_police', 'police', amount)
										end)
									end
								end
							end,
		...
		elseif data.current.value == 'refuerzos' then
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'refuerzospolice', {
				css      = 'police',
				...
				if action == 'petite_demande' then
					local raison = 'petit'
					TriggerServerEvent('refuerzospolice', coords, raison)
...
RegisterNetEvent('esx_policejob:hathndcuff')
AddEventHandler('esx_policejob:hathndcuff', function()
...
RegisterNetEvent('esx_policejob:bridas')
AddEventHandler('esx_policejob:bridas', function()
		...
		if CurrentAction then
			...
			if IsControlJustReleased(0, 38) and ESX.PlayerData.job and ESX.PlayerData.job.name == 'police' then
				...
				elseif CurrentAction == 'menu_boss_actions' then
					ESX.UI.Menu.CloseAll()
					TriggerEvent('esx_society:openBosthsMenu', 'police', function(data, menu)
						menu.close()
...
RegisterNetEvent('esx_policejob:doarreste1d')
AddEventHandler('esx_policejob:doarreste1d', function()
	Citizen.Wait(250)
	loadanimdict('mp_arrest_paired')
...
-- Refuerzos police--
RegisterNetEvent('refuerzospolice:setBlip')
AddEventHandler('refuerzospolice:setBlip', function(coords, raison)
	if raison == 'petit' then
		PlaySoundFrontend(-1, "Start_Squelch", "CB_RADIO_SFX", 1)
		PlaySoundFrontend(-1, "OOB_Start", "GTAO_FM_Events_Soundset", 1)
		ESX.ShowAdvancedNotification('Radio police', '~b~Peticion de refuerzos', 'Se requieren refuerzos.\n~w~Importancia: ~g~LEVE.\n \n', 'CHAR_CALL911', 8)
		Wait(1000)
