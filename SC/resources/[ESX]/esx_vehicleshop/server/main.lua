...
RegisterServerEvent('esx_vehicleshop:setVehicleOwnedth')
AddEventHandler('esx_vehicleshop:setVehicleOwnedth', function (vehicleProps)
...
RegisterServerEvent('esx_vehicleshop:setVehicleOwnedthPlayerId')
AddEventHandler('esx_vehicleshop:setVehicleOwnedthPlayerId', function (playerId, vehicleProps)
...
RegisterServerEvent('esx_vehicleshop:setVehicleOwnedthSociety')
AddEventHandler('esx_vehicleshop:setVehicleOwnedthSociety', function (society, vehicleProps)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
