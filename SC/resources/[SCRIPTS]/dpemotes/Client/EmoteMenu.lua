...
if Config.CustomMenuEnabled then
  local RuntimeTXD = CreateRuntimeTxd('7yt9bgm.png')
  local Object = CreateDui(Config.MenuImage, 512, 128)
  _G.Object = Object
  local TextureThing = GetDuiHandle(Object)
  local Texture = CreateRuntimeTextureFromDuiHandle(RuntimeTXD, '7yt9bgm.png', TextureThing)
  Menuthing = "7yt9bgm.png"
end
...
function AddInfoMenu(menu)
  if not UpdateAvailable then
    infomenu = _menuPool:AddSubMenu(menu, Config.Languages[lang]['infoupdate'], "(1.0.1)", "", Menuthing, Menuthing)
  else
  ...
  u170 = NativeUI.CreateItem("1.0.1", "All animations have been updated.")
